...
static char *font = "Iosevka Nerd Font:pixelsize=19:antialias=true:autohint=true";
static char *font2[] = { "Iosevka Nerd Font:pixelsize=19:antialias=true:autohint=true" };
